...
<div className={"mangas-con mt-5 "}>
  ...
  <div className="manga-label-more-con flex justify-between mb-2 items-end">
    ...
    <input type="text" placeholder="Search list..." name="list-search"
      className="list-search bg-zinc-800 text-sm px-2 py-1 border border-zinc-400 rounded w-full max-w-80" />
  </div>
