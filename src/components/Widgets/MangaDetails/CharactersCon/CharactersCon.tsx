  ...
  return (
    <div className="characters-con mt-5">
      <div className="label-con">
        <h4 className="characters-label">{title} characters</h4>
      </div>
              ...
              <li key={index} className="character-item" title={name}>
                <div className="inner-con flex flex-col gap-2 justify-center items-center">
                  ...
                  <img
                    src={picture}
                    alt={name}
                    className="character-image rounded-full w-20 h-20 object-cover object-top border border-zinc-600"
                  />
                  <p className="name text-nowrap text-sm" title={name}>
                    {truncate(name, 50)}
                  </p>
                </div>
              </li>
